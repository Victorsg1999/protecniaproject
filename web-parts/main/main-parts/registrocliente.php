			...
			<form action="" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-6">
						...
						<input class="form-control" id="name" name="nombre" type="text" required autofocus>
					</div>
					<div class="col-md-6">
						<label for="name">Apellidos</label>
						<input class="form-control" id="name" name="apellidos" type="text" required autofocus>
					</div>
					<div class="col-md-6">
						<label for="name">Correo Electronico</label>
						<input class="form-control" id="name" name="email" type="text" autofocus>
					</div>
					<div class="col-md-6">
						<label for="name">Telefono</label>
						<input class="form-control" id="name" name="telefono" type="text" required autofocus>
					</div>
					<!--
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<input class="form-control" id="name" name="ciudad" type="text" required autofocus>
					</div>
					<div class="col-md-6">
						<label for="name">C.P</label>
						<input class="form-control" id="name" name="cp" type="text" required autofocus>
					</div>
					<!--
					<div class="col-md-3">
					...
					<div class="row separacioncontroles">
						<div class="col text-right">
							<a href="" type="reset" class="btn btn-danger btncancelar">Cancelar</a>
							<button type="submit" name="guardar" class="btn btn-success btnguardar">Guardar</button>
						</div>
					</div>
				</div>
			</form>
